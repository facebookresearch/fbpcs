...
class ListMetadataResponse(object):
    ...
    def __init__(self, key_values=None, next_key_start=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.next_key_start = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.next_key_start is not None:
            ...
            oprot.writeString(self.next_key_start.encode('utf-8') if sys.version_info[0] == 2 else self.next_key_start)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
ListMetadataResponse.thrift_spec = (
    ...
    (2, TType.STRING, 'next_key_start', 'UTF8', None, ),  # 2
)
