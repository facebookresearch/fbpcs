...
class InvalidRequestError(TException):
    ...
    def __init__(
        ...
        super(InvalidRequestError, self).__setattr__("error_message", error_message)
...
class InternalServerError(TException):
    ...
    def __init__(
        ...
        super(InternalServerError, self).__setattr__("error_message", error_message)
...
class PutMetadataRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.entity_value is not None:
            ...
            oprot.writeString(
                self.entity_value.encode("utf-8")
                if sys.version_info[0] == 2
                else self.entity_value
            )
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ListMetadataRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.entity_key_start is not None:
            ...
            oprot.writeString(
                self.entity_key_start.encode("utf-8")
                if sys.version_info[0] == 2
                else self.entity_key_start
            )
            oprot.writeFieldEnd()
        if self.entity_key_end is not None:
            oprot.writeFieldBegin("entity_key_end", TType.STRING, 3)
            oprot.writeString(
                self.entity_key_end.encode("utf-8")
                if sys.version_info[0] == 2
                else self.entity_key_end
            )
            oprot.writeFieldEnd()
...
class ListMetadataResponse(object):
    ...
    def __init__(
        ...
        self.next_key_start = next_key_start
    ...
    def write(self, oprot):
        ...
        if self.key_values is not None:
            ...
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.next_key_start is not None:
            oprot.writeFieldBegin("next_key_start", TType.STRING, 2)
            oprot.writeString(
                self.next_key_start.encode("utf-8")
                if sys.version_info[0] == 2
                else self.next_key_start
            )
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
