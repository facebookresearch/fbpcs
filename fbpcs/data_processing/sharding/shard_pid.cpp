...
int main(int argc, char **argv) {
  ...
  data_processing::sharder::runShardPid(
      FLAGS_input_filename, FLAGS_output_filenames, FLAGS_output_base_path,
      FLAGS_file_start_index, FLAGS_num_output_files, FLAGS_log_every_n,
