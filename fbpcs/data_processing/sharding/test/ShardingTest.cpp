...
TEST(ShardTest, RunWithOutputFilenames) {
  ...
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(0),
                                                   expectedOutBasic.at(0));
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(1),
                                                   expectedOutBasic.at(1));
}
...
TEST(ShardTest, RunWithOutputBasePath) {
  ...
  runShard(inputPath, "", outputBasePath, static_cast<int32_t>(rand), 2,
           1'000'000);
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(0),
                                                   expectedOutBasic.at(0));
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(1),
...
TEST(ShardPidTest, RunWithOutputBasePath) {
  ...
  runShardPid(inputPath, "", outputBasePath, static_cast<int32_t>(rand), 2,
              1'000'000, "");
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(0),
                                                   expectedOutPid.at(0));
  data_processing::test_utils::expectFileRowsEqual(outputFilenames.at(1),
