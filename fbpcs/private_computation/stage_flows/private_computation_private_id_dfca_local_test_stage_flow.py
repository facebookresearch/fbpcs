...
class PrivateComputationPrivateIdDfcaLocalTestStageFlow(
    PrivateComputationBaseStageFlow
):
    """
    ...
    _order_ = "CREATED PID_SHARD PID_PREPARE ID_MATCH ID_MATCH_POST_PROCESS ID_SPINE_COMBINER PRIVATE_ID_DFCA_AGGREGATE POST_PROCESSING_HANDLERS"
    ...
    PRIVATE_ID_DFCA_AGGREGATE = PrivateComputationStageFlowData(
        initialized_status=PrivateComputationInstanceStatus.PRIVATE_ID_DFCA_AGGREGATION_INITIALIZED,
        started_status=PrivateComputationInstanceStatus.PRIVATE_ID_DFCA_AGGREGATION_STARTED,
        completed_status=PrivateComputationInstanceStatus.PRIVATE_ID_DFCA_AGGREGATION_COMPLETED,
        failed_status=PrivateComputationInstanceStatus.PRIVATE_ID_DFCA_AGGREGATION_FAILED,
        is_joint_stage=True,
    )
    ...
    def get_stage_service(
        ...
        if self is self.PRIVATE_ID_DFCA_AGGREGATE:
            return PrivateIdDfcaAggregateStageService(
