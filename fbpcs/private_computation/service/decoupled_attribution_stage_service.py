...
class AttributionStageService(PrivateComputationStageService):
    """Handles business logic for the decoupled private attribution stage
    ...
    async def run_async(
        ...
        logging.info("Starting to run MPC instance for decoupled attribution.")
        stage_data = PrivateComputationServiceData.DECOUPLED_ATTRIBUTION_STAGE_DATA
        ...
        mpc_instance = await create_and_start_mpc_instance(
            ...
            instance_id=pc_instance.infra_config.instance_id + "_decoupled_attribution",
            game_name=game_name,
