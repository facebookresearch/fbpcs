...
Usage:
    ...
    pc-cli run_study <study_id> --config=<config_file> --objective_ids=<objective_ids> --input_paths=<input_paths> [--output_dir=<output_dir> --tries_per_stage=<tries_per_stage> --result_visibility=<result_visibility> --run_id=<run_id> --graphapi_version=<graphapi_version> --graphapi_domain=<graphapi_domain> --dry_run --stage_timeout_override=<stage_timeout_override>] [options]
...
def main(argv: Optional[List[str]] = None) -> None:
    s = schema.Schema(
        {
            ...
            "--stage_timeout_override": schema.Or(None, schema.Use(int)),
    ...
    stage_timeout_override = arguments["--stage_timeout_override"]
