...
TARGET_ID_FIELD = "target_id"  # publisher side
ACTION_TYPE_FIELD = "action_type"  # publisher side
CONVERSION_TARGET_ID_FIELD = "conversion_target_id"  # partner side
CONVERSION_ACTION_TYPE_FIELD = "conversion_action_type"  # partner side
...
ALL_FIELDS: List[str] = [
    ...
    TARGET_ID_FIELD,
    ACTION_TYPE_FIELD,
    CONVERSION_TARGET_ID_FIELD,
    CONVERSION_ACTION_TYPE_FIELD,
]
...
VALIDATION_REGEXES: Dict[str, Pattern[str]] = {
    ...
    TARGET_ID_FIELD: INTEGER_REGEX,
    ACTION_TYPE_FIELD: INTEGER_REGEX,
    CONVERSION_TARGET_ID_FIELD: INTEGER_REGEX,
    CONVERSION_ACTION_TYPE_FIELD: INTEGER_REGEX,
}
