...
GRAPHAPI_INSTANCE_STATUSES: Dict[str, PrivateComputationInstanceStatus] = {
    ...
    "PCF2_LIFT_METADATA_COMPACTION_STARTED": PrivateComputationInstanceStatus.PCF2_LIFT_METADATA_COMPACTION_STARTED,
    "PCF2_LIFT_METADATA_COMPACTION_COMPLETED": PrivateComputationInstanceStatus.PCF2_LIFT_METADATA_COMPACTION_COMPLETED,
    "PCF2_LIFT_METADATA_COMPACTION_FAILED": PrivateComputationInstanceStatus.PCF2_LIFT_METADATA_COMPACTION_FAILED,
    ...
    "PCF2_SHARD_COMBINE_STARTED": PrivateComputationInstanceStatus.PCF2_SHARD_COMBINE_STARTED,
    "PCF2_SHARD_COMBINE_COMPLETED": PrivateComputationInstanceStatus.PCF2_SHARD_COMBINE_COMPLETED,
    "PCF2_SHARD_COMBINE_FAILED": PrivateComputationInstanceStatus.PCF2_SHARD_COMBINE_FAILED,
