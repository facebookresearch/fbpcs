...
class PrivateComputationPartnerInstance(PrivateComputationCalcInstance):
    ...
    def _need_override_input_path(self, instance: PrivateComputationInstance) -> bool:
        ...
        """
        if self.input_path == instance.product_config.common.input_path:
            return False
        ...
        if self.status in (
            ...
            raise PCInstanceCalculationException(
                f"Unable to override input path {self.input_path} to exisiting instance input path {instance.product_config.common.input_path}",
